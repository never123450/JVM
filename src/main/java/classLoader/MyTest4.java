...
/*
    ...
    助记符：
        anewarray：表示创建一个引用类型的（如类，接口，数组）数组，并将其引用的值压入栈顶
        newarray：表示创建一个指定的元素类型（如：int、float、char等）的数组，并将引用的值压入栈顶
...
//        MyParent4 myParent4 = new MyParent4();
        ...
        System.out.println(myParent4s.getClass());//class [LclassLoader.MyParent4;
        ...
        System.out.println(myParent4s1.getClass().getSuperclass());//class java.lang.Object
        System.out.println("==========");
